...
class StrategyOrangeTeam2 extends MageStrategy {
    constructor(myTeam, myId) {
        super(myTeam, myId);
    }
...
class StrategyOrangeTeam3 extends MageStrategy {
    constructor(myTeam, myId) {
        super(myTeam, myId);
    }
...
class StrategyOrangeTeam4 extends MageStrategy {
    constructor(myTeam, myId) {
        super(myTeam, myId);
    }
...
class StrategyOrangeTeam5 extends MageStrategy {
    constructor(myTeam, myId) {
        super(myTeam, myId);
    }
